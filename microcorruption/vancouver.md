...
The code in the previous tutorial solves by calling <unlock_door>. <unlock_door> pushes 0x7f on the stack then calls the interrupt handler which unlocks it. This method was missing from this challenge so I'd have to write it into the free space through getsn(). 
